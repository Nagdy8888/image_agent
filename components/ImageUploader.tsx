...
export default function ImageUploader({ onUpload, onReset, disabled, previewUrl, metadata }: ImageUploaderProps) {
          ...
          {onReset && (
            <div className="border-t border-slate-600/50 p-3">
              <button
                type="button"
                onClick={onReset}
                className="w-full rounded-lg border border-indigo-500/50 bg-indigo-500/20 px-4 py-2 text-sm font-medium text-indigo-200 transition hover:bg-indigo-500/30"
              >
                Analyze New Image
              </button>
            </div>
